...
!!! note
    ...
    Consulte [a documentação oficial](https://docs.pygeoapi.io/en/latest/publishing/ogcapi-records.html) para mais informações sobre backends de catálogo/metadados suportados
